...
// enqueue css
function nonprofit_common_custom_css(){
    
    wp_enqueue_style( 'nonprofit-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= nonprofit_opt( 'nonprofit_theme_color' );
		$themeSecColor     		  	= '';
		$bookBtnColor       		= nonprofit_opt( 'nonprofit_donate_btn_color' ) != '#ffffff' ? nonprofit_opt('nonprofit_donate_btn_color') : '';
		$bookBtnHvrBgColor       	= nonprofit_opt( 'nonprofit_donate_btn_hvr_bg_color' ) != '#ffffff' ? nonprofit_opt('nonprofit_donate_btn_hvr_bg_color') : '';
		$bookBtnHvrColor     		= nonprofit_opt( 'nonprofit_donate_btn_hvr_color' ) != '#450000' ? nonprofit_opt('nonprofit_donate_btn_hvr_color') : '';
		$hoverColor     	  	  	= nonprofit_opt( 'nonprofit_quote_btn_hvr_text_color');

		$headerTop_bg     		  	= '';
		$navbarBgColor     		  	= nonprofit_opt( 'nonprofit_navbar_bg_color' ) != '#082b49' ? nonprofit_opt( 'nonprofit_navbar_bg_color') : '';
		$headerTop_col     		  	= nonprofit_opt( 'nonprofit_top_header_color' );
		$bookBtnBgColor     		= '';
		$bookBtnHoverBgColor     	= '';

		$headerTopBg      		  	= nonprofit_opt( 'nonprofit_top_header_bg_color');
		$headerBg          		  	= nonprofit_opt( 'nonprofit_header_bg_color') != '#450000' ? nonprofit_opt( 'nonprofit_header_bg_color') : '';
		$menuColor          	  	= nonprofit_opt( 'nonprofit_header_menu_color' ) != '#ffffff' ? nonprofit_opt('nonprofit_header_menu_color') : '';
		$menuHoverColor           	= nonprofit_opt( 'nonprofit_header_menu_hover_color' ) != '#a70000' ? nonprofit_opt('nonprofit_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      	= nonprofit_opt( 'nonprofit_header_menu_fixed_hover_color' );
		$dropMenuBgColor          	= nonprofit_opt( 'nonprofit_header_drop_menu_bg_color' ) != '#ffffff' ? nonprofit_opt('nonprofit_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            	= nonprofit_opt( 'nonprofit_dropdown_menu_color' ) != '#000000' ? nonprofit_opt('nonprofit_dropdown_menu_color') : '';
		$dropMenuHovColor         	= nonprofit_opt( 'nonprofit_dropdown_menu_hover_color' ) != '#a70000' ? nonprofit_opt('nonprofit_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  	= nonprofit_opt( 'nonprofit_footer_widget_bg_color' ) != '#a70000' ? nonprofit_opt('nonprofit_footer_widget_bg_color') : $themeColor;
		$footerwHeadColor   	  	= nonprofit_opt('nonprofit_footer_widget_heading_color');
		$footerwTextColor   	  	= nonprofit_opt('nonprofit_footer_widget_text_color');
		$footerwanchorcolor 	  	= nonprofit_opt('nonprofit_footer_widget_anchor_color') != '#bababa' ? nonprofit_opt('nonprofit_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    	= nonprofit_opt('nonprofit_footer_widget_anchor_hover_color') != '#a70000' ? nonprofit_opt('nonprofit_footer_widget_anchor_hover_color') : $themeColor;
		
		$fofbg					  	= nonprofit_opt('nonprofit_fof_bg_color');
		$foftonecolor			  	= nonprofit_opt('nonprofit_fof_textone_color');
		$fofttwocolor			  	= nonprofit_opt('nonprofit_fof_texttwo_color');

		$bannerBtnHeaderSpanColor 	= $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  	= nonprofit_opt('nonprofit_footer_widget_anchor_color') != '#e5e5e5' ? nonprofit_opt('nonprofit_footer_widget_anchor_color') : $themeSecColor;
		...
		$customcss ="			
			...
			{
				border-color: {$bookBtnHvrBgColor};
				background: {$bookBtnHvrBgColor};
				color: {$bookBtnHvrColor} !important;
			}
			.sub_menu
			{
			...
			.btn_4, .our_Professional .single_industries_text:hover, .pricing_part .single_pricing_part .pricing_content .btn_2:hover, .comment-form .comment-respond .btn_2:hover, .popular_cource .single_popular_cource .btn_2:hover, .gallery_part .btn_2:hover, .single_sidebar_widget.widget_search .boxed-btn:hover{
				border-color: {$themeColor};
				background-color: {$themeColor};
			}
			.btn_4:hover, .about-area .section-title .boxed-btn:hover, .comment-form .form-group .boxed-btn, .search-page .backtohome .btn_1, .contact-section .button-contactForm {
				color: {$themeColor}!important;
			}
			...
			.header-area .main-header-area .main-menu ul li a .nav-link:not(.submenu):hover, .header-area .main-header-area .main-menu ul li a.submenu:hover, .main_menu:not(.menu_fixed) ul.navbar-nav > li > a:hover, .header-area .main-header-area .main-menu ul li a:hover
			{
			...
			.footer .copy-right_text .copy_right a:hover, .footer_area .single-footer-widget ul li a, .causes_area .causes_info .target_rais_area .single_raise h4, .boxed_btn3:hover, .volunteers_area .single_volunteer .thumb .social_links ul li a:hover
			{
			   color: {$themeColor};
			}
			.footer-area .btn {
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .nonprofit_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .nonprofit_mailchimp_newsletter_widget button
			{
			   background: {$footerwanchorhovcolor};
			}
			...
			.comment_form .btn_1.button:hover, .search-page .button.button-contactForm:hover, .f0f-content .button.button-contactForm:hover, .gallery_area .load_more_button .load_more_btn:hover, .slider_area .single_slider .slider_text .boxed-btn2:hover {
			...
			.form-contact .form-group .btn_1:hover, .single_sidebar_widget.widget_search .boxed-btn:hover, .comment-form .form-group .boxed-btn:hover, .search-page .backtohome .btn_1:hover, .f0f-content .btn_1:hover, .contact-section .button-contactForm:hover {
    ...
    wp_add_inline_style( 'nonprofit-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'nonprofit_common_custom_css', 50 );