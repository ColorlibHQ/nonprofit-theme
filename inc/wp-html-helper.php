...
// image default alt
if ( ! function_exists( 'nonprofit_img_default_alt' ) ) {
	function nonprofit_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'nonprofit_img_tag' ) ) {
	function nonprofit_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = nonprofit_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'nonprofit_anchor_tag' ) ) {
	function nonprofit_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'nonprofit_heading_tag' ) ) {
	function nonprofit_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'nonprofit_paragraph_tag' ) ) {
	function nonprofit_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'nonprofit_other_tag' ) ) {
	function nonprofit_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'nonprofit_button_element ' ) ) {
	function nonprofit_button_element( array $args ) {
